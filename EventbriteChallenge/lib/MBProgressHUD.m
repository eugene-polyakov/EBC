...
+(MBProgressHUD*)showProgressView: (NSObject <MBProgressHUDDelegate>*)controller withLabel: (NSString*)label {
	// The hud will dispable all input on the view
	UIView * view = nil;
	if ([controller isKindOfClass:[UIViewController class]])
		view = [(UIViewController *)controller view];
	else if ([controller isKindOfClass:[UIView class]])
	...
	progressView.delegate = controller;
